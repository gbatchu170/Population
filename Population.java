...
/**
 *	Population - Answers pre-programmed queries regarding cities in the US
 *  via sorting methods that outline various statistics of each city.
 *
...
public class Population {
	 ...
	 * readFile()
	 * 
	 * Reads the file, and stores it in Cities. Additionally initizlizes Cities.
	 */ 
	 ...
	 * main()
	 * 
	 * @param String[] args		No use other than to override the method
	 * 
	 * 
	 * Creates an instance of population, and runs the methods.
	 */  
	 ...
	 * selectionEnterer()
	 * 
	 * @return input	Contains the choice the user has inputted
	 * 
	 * Loops inputting as long as invalid inputs are given.
	 */ 
	 ...
	 * runChoice()
	 * 
	 * Runs the choices over and over, and calls methods from sortMethod.java
	 * to give answers to the users queries.
	 */ 
